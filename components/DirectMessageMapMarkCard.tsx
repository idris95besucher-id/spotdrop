...
type DirectMessageMapMarkCardProps = {
  body: string;
...
/** DM counterpart of CityRoomMapMarkCard — same encoding/creator crediting, no room-only chrome. */
export default function DirectMessageMapMarkCard({
  body,
  isOwnMessage,
  currentUserId,
  message,
}: DirectMessageMapMarkCardProps) {
